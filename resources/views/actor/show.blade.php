    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
      ...
      <div class="md:ml-24">
        ...
        <div class="flex flex-wrap items-center text-gray-400 text-sm mt-2">
          ...
          <span class="ml-2">{{ $actor['birthday'] }} ({{ $actor['age'] }} years old) @if ($actor['place_of_birth'])
        ...
        <div class="mt-12">
          <h4 class="text-white font-semibold">Know for</h4>

          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mt-4">
            @foreach ($knowForMovies as $movie)
              <div>
                <a href=""><img src="{{ $movie['poster_path'] }}" alt="poster"
