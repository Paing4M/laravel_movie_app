  ...
  <div class="movie-info border-b border-gray-800">
    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
      ...
      <div class="md:ml-24">
        ...
        <div class="flex items-center mt-12 gap-3">
          <a href="{{ route('addList', ['type' => 'movie', 'id' => $movie['id']]) }}"
            class="bg-gray-500  transition ease-in-out duration-150 hover:bg-gray-600  px-5 py-4 rounded capitalize">
            Add to your list
          </a>
    ...
    <div class="container mx-auto px-4 py-16">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
        @foreach ($movie['cast'] as $cast)
          <div class="mt-8">
            <a href="{{ route('show_actor', $cast['id']) }}">
